...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
        ...
        },{id: "nav-publications-amp-technical-reports",
          ...
          title: "repositories",
          description: "A collection of my open-source projects and contributions. These repositories showcase my work in robotics, computer vision, machine learning, and other technical domains. Feel free to explore, fork, or contribute to any project that interests you.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-our-paper-the-itobos-dataset-skin-region-images-extracted-from-3d-total-body-photographs-for-lesion-detection-is-now-available-on-arxiv-this-comprehensive-dataset-will-advance-research-in-automated-melanoma-detection",
          title: 'Our paper “The iToBoS dataset: skin region images extracted from 3D total body...',
          description: "",
          section: "News",},{id: "news-itobos-2024-skin-lesion-detection-challenge-successfully-concluded",
          ...
          section: "News",handler: () => {
            ...
            },},{id: "projects-metric-embedding-for-similarity-learning",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%64%65%6F%6C%61%6A%6F%73%65%70%68%6F%6C%6F%72%75%6E%74%6F%62%61@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/Joseph Adeola", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
